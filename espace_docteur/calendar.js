...
renderCalendar = () => {
    ...
    document.querySelector('.appointPlan .programme .date h1').innerHTML = months[date.getMonth()] + ' ' + date.getFullYear();
    //alert(months[date.getMonth()] + ' ' + date.getFullYear());
    //alert(new Date().toLocaleDateString());

    document.querySelector('.date p').innerHTML = new Date().toLocaleDateString();
    document.querySelector('.appointPlan .programme .date p').innerHTML = new Date().toLocaleDateString();
...
document.querySelector('.appointPlan .programme .prev').onclick = () => {
    date.setMonth(date.getMonth() - 1);
    renderCalendar();
}

document.querySelector('.appointPlan .programme .next').onclick = () => {
    date.setMonth(date.getMonth() + 1);
    renderCalendar();
}
